...
import { Plus, BookOpen, Eye, Edit2 } from "lucide-react";
...
export function CoursesPage({
  ...
  const handleAdd = (data: Omit<Course, "id" | "batches" | "enrolled">) => {
  ...
  const handleEdit = (data: Omit<Course, "id" | "batches" | "enrolled">) => {
