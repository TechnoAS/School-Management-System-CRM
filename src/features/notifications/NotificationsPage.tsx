...
import { Wallet, UserPlus, Award, FileText, Bell } from "lucide-react";
    ...
    <div>
      <div className="flex items-start justify-between mb-6">
        ...
        <div className="flex gap-2">
          <Btn variant="secondary" size="sm" onClick={() => setItems(prev => prev.map(n => ({ ...n, read: true })))}>
            Mark all read
          </Btn>
          <Btn
            size="sm"
              ...
              <div className="flex items-start gap-3">
                ...
                {!n.read && (
                  <button
                    ...
                    className="text-xs text-muted-foreground hover:text-foreground transition-colors shrink-0 pt-0.5 bg-transparent border-0 cursor-pointer"
                  >
                    Mark read
                  </button>
                )}
